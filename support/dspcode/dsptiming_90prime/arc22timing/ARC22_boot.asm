...
This file is used to generate boot DSP code for the 250 MHz fiber optic timing board 
using a DSP56303 as its main processor.

Added utility board support Dec. 2002
Integration Dither OFF Aug., 2012
	*
...
START	MOVE	X:<IDL_ADR,R0		
	JSET    #TIM_BIT,X:TCSR0,CHK_TIM	; MPL If exposing go check the timer
...
STATUS	DC	$64			; Controller status bits ST_DITH OFF
