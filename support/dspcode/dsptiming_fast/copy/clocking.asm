...
; 31Aug15 MPL after ARC suggestion for delay
...
; CDS integrate on noise
		DC	        VIDEO+$050000+%0011011  ; Stop resetting int - new was 0
...
; CDS integrate on signal
		DC	        VIDEO+$0A0000+%0010111	; change polarity new was 2
		DC	          VIDEO+DWELL+%0000111	; Integrate signal
		DC	        VIDEO+$020000+%0010111  ; Stop integrate, ADC is sampling
		DC	        VIDEO+$000000+%1110111  ; start A/D conversion
  		DC	        VIDEO+$000000+%0010111  ; End start A/D conv. pulse
	ENDM
...
SXFER0	DC	ESXFER0-SXFER0-1
		...
		DC      VIDEO+$040000+%0011000                  ; Reset integrator & DC restore
